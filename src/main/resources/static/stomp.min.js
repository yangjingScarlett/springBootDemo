    ...
    e = function () {
                ...
                return this.ponger = i.setInterval(s, function () {
                    ...
                    if (t > s * 2) {
                        if (typeof f.debug === "function") {
                            f.debug("did not receive server activity for the last " + t + "ms")
                        }
                        return f.ws.close()
                    }
                })
        ...
        r.prototype.connect = function () {
            ...
            this.ws.onmessage = function (i) {
                ...
                a = typeof ArrayBuffer !== "undefined" && i.data instanceof ArrayBuffer ? (r = new Uint8Array(i.data), typeof c.debug === "function" ? c.debug("--- got data length: " + r.length) : void 0, function () {
                        var t, e, n;
                        n = [];
                ...
                for (d = 0, g = b.length; d < g; d++) {
                    ...
                    switch (f.command) {
                        case"CONNECTED":
                            ...
                            m.push(typeof c.connectCallback === "function" ? c.connectCallback(f) : void 0);
                            break;
                        case"MESSAGE":
                            ...
                            if (l) {
                                ...
                                m.push(typeof c.debug === "function" ? c.debug("Unhandled received MESSAGE: " + f) : void 0)
                            }
                            break;
                        case"RECEIPT":
                            m.push(typeof c.onreceipt === "function" ? c.onreceipt(f) : void 0);
                            break;
                        case"ERROR":
                            m.push(typeof s === "function" ? s(f) : void 0);
                            break;
                        default:
                            m.push(typeof c.debug === "function" ? c.debug("Unhandled frame: " + f) : void 0)
                    }
                }
                return m
            };
